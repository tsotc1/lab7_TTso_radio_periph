...
int main()
{
    ...
    init_platform();
    print("\r\n\r\n\r\nLab 7 T.Tso - Custom Peripheral Demonstration\n\r");
    ...
    printf("Elapsed time in clocks = %lu\n",stop_time-start_time);
    float throughput=0;
    ...
    // Each read of the TIMER_REG_OFFSET is a transfer of 32 bits or 4 bytes
    // Hence, the throughput is (4 bytes * 2048 transfers) / (clocks/125e6)
    throughput = (4 * 2048) / ((stop_time-start_time)/125e6);
    throughput = throughput / 1048576;
