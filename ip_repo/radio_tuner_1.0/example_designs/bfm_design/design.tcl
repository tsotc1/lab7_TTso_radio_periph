proc create_ipi_design { offsetfile design_name } {
	...
	set radio_tuner_0 [ create_bd_cell -type ip -vlnv jhuapl.edu:user:radio_tuner:1.0 radio_tuner_0]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores jhuapl.edu:user:radio_tuner:1.0]]]]
